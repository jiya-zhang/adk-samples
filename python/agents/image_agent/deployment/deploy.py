...
cloudpickle.register_pickle_by_value(image_agent)

def deploy_agent(project_id: str, staging_bucket: str = None, location: str = "us-central1"):
    print(f"🚀 Deploying image_agent to Vertex AI in {location}...")
    ...
    remote_agent = agent_engines.create(
        ...
        extra_packages=[os.path.join(project_root, "image_agent")],
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Deploy image_agent to Vertex AI.")
